#pragma GCC optimize("Os")    // 205 kFLOPS
//~ #pragma GCC optimize("O0")    // 160 kFLOPS
//~ #pragma GCC optimize("O1")    // 204 kFLOPS
//~ #pragma GCC optimize("O2")    // 205 kFLOPS
//#pragma GCC optimize("O3")    // 220 kFLOPS (LGT@32MHz) ; 109kFLOPS (LGT@16MHz) ; 90 kFLOPS(Atmega328p)
// #pragma GCC optimize("Ofast") // 226 kFLOPS (LGT@32MHz) ; 112kFLOPS (LGT@16MHz) ; 92 kFLOPS (Atmega328p)
